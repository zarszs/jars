...
• Command: <code>{cmd[0]}sosmed</code> [link]
• Function: Untuk Mendownload Media Dari Facebook/Tiktok/Instagram/Twitter/YouTube.
"

@ubot.on_message(filters.me & filters.command("sosmed", cmd))
