...
from Amang import *
from Amang.utils import eor, http

__MOD__ = "quote"
__HELP__ = f"""
 Document for Quote

• Command: <code>{cmd[0]}q</code> [balas pesan]
• Function: Untuk quote.

• Command: <code>{cmd[0]}q</code> [balas pesan][angka]
• Function: Ini akan membuat beberapan pesan menjadi quote.
"""
...
@ubot.on_message(filters.me & filters.command("q", cmd))
